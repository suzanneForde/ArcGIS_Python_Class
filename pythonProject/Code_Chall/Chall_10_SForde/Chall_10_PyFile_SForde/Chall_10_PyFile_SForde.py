...
###
# Task 1
# Use what you have learned to process the Landsat files provided.
# This time, you are interested in the NVDI index which will use Bands 4 (red, aka vis) and 5 (near-infrared, aka nir)
# from the Landsat 8 imagery,
